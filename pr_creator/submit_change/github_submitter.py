...
class GithubSubmitter(SubmitChange):
    def __init__(self) -> None:
        ...
        self.commit_message = os.environ.get("SUBMIT_COMMIT_MESSAGE", "Automated changes")
        self.pr_title = os.environ.get("SUBMIT_PR_TITLE", self.commit_message)
        self.pr_body = os.environ.get("SUBMIT_PR_BODY", "Automated changes generated by pr-creator.")
    ...
    def _prepare_branch(self, repo_path: Path, base_branch: str) -> str:
        ...
        if current != "HEAD" and current != base_branch and not current.startswith("auto/"):
            return current
    ...
    def _create_pr(self, repo_path: Path, branch: str) -> None:
        cmd = [
            "gh",
            "pr",
            "create",
